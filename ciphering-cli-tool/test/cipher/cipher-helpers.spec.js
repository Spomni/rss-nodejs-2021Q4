...
describe('cipher-helpers', () => {
  ...
  describe('getInputStream():', function () {
    ...
    it('Should return an instance of the InputSteam class', function () {
      expect(getInputStream()).toBeInstanceOf(InputStream)
  ...
  describe('getOutputStream():', function () {
    ...
    it('Should return an instance of the OutputSteam class', function () {
      expect(getOutputStream()).toBeInstanceOf(OutputStream)
